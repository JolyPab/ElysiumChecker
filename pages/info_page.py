...
class InfoPage(QWidget):
    ...
    def _build_ui(self):
        ...
        paragraphs = [
            ...
            "запрещённого программного обеспечения (читов) на серверах Elysium CS2.",
            ...
            "Steam-аккаунт на бани, анализирует процесс игры и запускает "
            "специализированные утилиты для форензик-анализа.",
